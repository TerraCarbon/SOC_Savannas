...
#
# Implements Verra Appendix 6 (“Tool for quantifying organic carbon stocks 
# using digital soil mapping: calibration, validation, and uncertainty estimation”),
# following Wadoux & Heuvelink (2023).  
#
# Workflow:
